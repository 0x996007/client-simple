import { mainnet, arbitrum, base, polygon, optimism, arbitrumSepolia, sepolia } from '@reown/appkit/networks'

export const ETH_CHAINS = [arbitrumSepolia, mainnet, arbitrum, base, polygon, optimism, sepolia]
